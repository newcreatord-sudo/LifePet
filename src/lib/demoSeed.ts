...
export function ensureDemoSeed(userId: string) {
  ...
  const pet1: Pet = {
    ...
    dietNotes: "Demo diet: split meals, avoid grapes/chocolate.",
  ...
  const pet2: Pet = {
    ...
    dietNotes: "Demo diet: wet food AM/PM + water fountain.",
  ...
  const notifications1: PetNotification[] = [
    {
      ...
      type: "hydration",
      title: "Water check",
      body: "Today’s water intake seems low. Refresh the bowl and observe.",
      severity: "warning",
  ...
  const posts: CommunityPost[] = [
    {
      ...
      text: "Any tips for itchy skin during spring?",
      petTag: { species: "dog" },
      likeCount: 2,
    },
  ];
  ...
  const listings: MarketplaceListing[] = [
    {
      ...
      sellerId: userId,
      createdAt: now - 1000 * 60 * 60 * 24,
      title: "Ceramic water bowl",
      description: "Anti-slip, easy to clean.",
